namespace Unity.Burst.Intrinsics
{
	public unsafe static partial class X86
	{
		...
		public enum MXCSRBits
		{
			...
			/// </summary>
			ExceptionMask = PrecisionMask | UnderflowMask | OverflowMask | DivideByZeroMask | DenormalOperationMask |
			...
			/// </summary>
			FlagMask = PrecisionFlag | UnderflowFlag | OverflowFlag | DivideByZeroFlag | DenormalFlag |
