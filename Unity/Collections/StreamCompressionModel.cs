...
namespace Unity.Collections
{
    ...
    public unsafe struct StreamCompressionModel
    {
        ...
        {
            internal static readonly BurstLike.SharedStatic<StreamCompressionModel> Default = BurstLike.SharedStatic<StreamCompressionModel>.GetOrCreate<StreamCompressionModel>();
        }
