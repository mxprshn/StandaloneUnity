...
namespace Unity.Collections
{
    ...
    public static class AllocatorManager
    {
        ...
        {
            internal sealed class IsInstalled { internal static readonly BurstLike.SharedStatic<Long1024> Ref = BurstLike.SharedStatic<Long1024>.GetOrCreate<IsInstalled>(); }
            internal sealed class TableEntry { internal static readonly BurstLike.SharedStatic<Array32768<AllocatorManager.TableEntry>> Ref = BurstLike.SharedStatic<Array32768<AllocatorManager.TableEntry>>.GetOrCreate<TableEntry>(); }
            internal sealed class IsAutoDispose { internal static readonly BurstLike.SharedStatic<Long1024> Ref = BurstLike.SharedStatic<Long1024>.GetOrCreate<IsAutoDispose>(); }
#if ENABLE_UNITY_COLLECTIONS_CHECKS
