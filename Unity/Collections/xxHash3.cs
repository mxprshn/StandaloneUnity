...
namespace Unity.Collections
{
    ...
    public static partial class xxHash3
    {
        ...
        private static ulong umul128(ulong x, ulong y, out ulong high)
        {
            ...
            ulong num6 = (ulong) num2 * num3;
            ulong num7 = num4 * num1;
            long num8 = (long) num1 * (long) num3;
            ulong num9 = (ulong) (uint) num6;
            ulong num10 = (ulong) (num8 >>> 32);
            ulong num11 = num6 >> 32;
